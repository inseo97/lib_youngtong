        ...
        <aside>
            <div id="remote">
                ...
                <div class="remote_wrap">
                    <ul id="lnb">
                        <li class="th2"><a href="#" target='_self' class='link_2th_ov'><span>이용시간안내</span></a>
                        </li>
                        <li class="th2"><a href="#" target='_self' class='link_2th'><span>열람실이용</span></a>
                        </li>
                        <li class="th2"><a href="#" target='_self' class='link_2th'><span>대출회원가입</span></a>
                        </li>
                        <li class="th2"><a href="#" target='_self' class='link_2th'><span>전자도서관</span></a>
                        </li>
                    </ul>
        </aside>
        <article>
            <span class="fl content-Title">이용시간 안내</span>
            <div id="location" class="title_wrap">
                ...
                <div class="utile_wrap">
                    ...
                    <ul class="location_wrap">
                        ...
                        <li><a href='#'>이용안내 </a></li>
                        <li class="last on"><a href="#toggle"> 이용시간안내 </a></li>
            ...
            <div class="using_content">
                <img src="./images/clock3d.png" width="200" alt="시계">
                ...
                <ul class="calTime">
                    <li>
                        ...
                        if (day_time < 9) document.write("<h3 style='color:#ff4848'>영통도서관 운영중이 아닙니다.</h3>");
                        else if (day_time < 18) document.write("<h3 style='color:#3E85EF'>영통도서관 운영중입니다.</h3>");
                        else document.write("<h3 style='color:#ff4848'>영통도서관 운영중이 아닙니다.</h3>");
                        </script>
                        <script>
                        var current = new Date(); //내장 메서드.
