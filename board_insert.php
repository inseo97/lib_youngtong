...
<?php
	...
	$sql = "insert into board (id, name, subject, content, regist_day, hit, file_name, file_type, file_copied, level) ";

	$sql .= "values('$userid', '$username', '$subject', '$content', '$regist_day', 0, '$level'";
	...
	$new_point = $row["point"] + $point_up; // 기존 포인트에 $point_up을 더합니다.
